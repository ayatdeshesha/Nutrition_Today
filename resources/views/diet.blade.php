...
<!--
 ...
 ojotha designer banaice ei section
 ektow valo lage nai ei section
 ki r kora amk to banate e hobe
 era j kobe buzbe allah janen
 -->

<div class="video-promtionOX  ">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="video-promoOX ">
                    <iframe width="100%" height="400" src="https://www.youtube.com/embed/jhOX-JYTnzk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
               </div>
            </div>
        </div>
    </div>
...
<path class="path-2"  d="M0,20.1v141.6h105.6c9.1,0,18.1,0.7,27.1,2.2c33.5,5.6,119.3,19.7,134.3,20.8c18.7,1.3,57.2,1.3,103-26.3
	V20.1C370,9,361,0,349.9,0H20.1C9,0,0,9,0,20.1z"/>
                    ...
                    <div class="priceBody" style="margin: auto; width: 90%;">
                        <p>This type of diet depends mainly on raising the daily portion of proteins you eat in
                             exchange for reducing the portion you eat daily from carbohydrates, and the amount of 
                             carbohydrates allowed to be eaten is raised in stages as the person approaches the desired weight.


                        </p>
                    </div><!-- end price body -->
                    <div class="priceFooter">
                        <a href="https://www.healthline.com/nutrition/atkins-diet-101" target="_blank"> Read More...</a>
                    </div><!-- end price footer -->
                </div>
            </div><!-- end single price -->
            <div class="col-lg-4 col-sm-6 col-12">
...
<path class="path-2"  d="M0,20.1v141.6h105.6c9.1,0,18.1,0.7,27.1,2.2c33.5,5.6,119.3,19.7,134.3,20.8c18.7,1.3,57.2,1.3,103-26.3
	V20.1C370,9,361,0,349.9,0H20.1C9,0,0,9,0,20.1z"/>
                        ...
                        <div class="price-header-content">
                            <h3>Mediterranean diet <br>diets
                            </h3>
                        </div>
                    </div><!-- end price header -->
                    <div class="priceBody" style="margin: auto; width: 90%;">
                        <p>This type of diet depends on eating the foods eaten by the peoples in the Mediterranean, while following these rules:

                            Focus on eating the following food items in abundance: vegetables, fruits, whole grains, seafood, olive oil, legumes, seeds, and nuts.
                    ...
                    <div class="priceFooter">
                        <a href="https://www.webteb.com/articles/%D9%81%D9%88%D8%A7%D8%A6%D8%AF-%D8%AD%D9%85%D9%8A%D8%A9-%D8%A7%D9%84%D8%A8%D8%AD%D8%B1-%D8%A7%D9%84%D8%A7%D8%A8%D9%8A%D8%B6-%D8%A7%D9%84%D9%85%D8%AA%D9%88%D8%B3%D8%B7_16893" target="_blank"> Read More...</a>
                    </div><!-- end price footer -->
                </div>
            </div><!-- end single price -->
            <div class="col-lg-4 col-sm-6 col-12">
...
This type of diet simply depends on eating only a group of juices for several days, or for several weeks while avoiding solid foods entirely.

The juices that are allowed to be consumed in this type of diet are many and varied, and it is important that they be made of fresh fruits and vegetables
                    ...
                    <div class="priceFooter">
                        <a href="https://www.eatingwell.com/article/278357/how-to-start-juicing-7-day-juice-plan-to-add-more-fruits-and-vegetables-to-your-diet/" target="_blank"> Read More...</a>
                    </div><!-- end price footer -->
                </div>
            </div><!-- end single price -->
        </div>
